package com.mygmaoweb.gmao.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gmao");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gmao");
        ...
        config.getMapConfigs().put("com.mygmaoweb.gmao.domain.*", initializeDomainMapConfig(jHipsterProperties));
